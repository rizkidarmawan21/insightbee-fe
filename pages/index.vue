    ...
    <div class="flex flex-col items-center justify-center min-h-screen">
        ...
        <div class="mt-6 w-full flex flex-col items-center justify-center">
            ...
            <div class="w-1/2 border-2 border-slate-200 p-3">
                ...
                <div v-else-if="!results && !loading" class="flex items-center justify-center">
                    ...
                    <div>
                        ...
                        <div class="mt-3" v-if="results.data?.references.length > 0">
                            ...
                            <div class="p-4 space-y-3">
                                <div v-for="(data, index) in results.data?.references" :key="index" class="flex gap-2">
                                    <div>
